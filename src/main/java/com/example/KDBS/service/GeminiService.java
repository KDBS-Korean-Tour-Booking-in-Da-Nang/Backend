...
public class GeminiService {
    ...
    private static final String TRAVEL_ASSISTANT_SYSTEM_PROMPT =
            ...
            - If the user asks in Korean (한국어), respond ONLY in Korean.
            - If the user asks in English, respond ONLY in English.
            - If the user asks in Vietnamese, respond ONLY in Vietnamese.
            Never mix languages or assume a default language. Always detect and match the user's language first. if there is other languages, respond in English.
            ...
            If users inquire about terms that haven't been translated into Korean on the system, translate them for the users in their question language.
            If users complain about the system, guide them to create a support ticket using the ticket button in the bottom-left corner of the homepage.
            Your tone should be friendly and professional like a tour guide. A little humor is allowed, suitable for Korean's sense of humor when answering Korean users.
            REMEMBER: Always respond in the same language as the incoming question. This is mandatory.
            """;
