        ...
        public void googleCallback(@RequestParam("code") String code, HttpServletResponse response) throws IOException {
                try {
                        ...
                        String frontendUrl = "http://localhost:3000/google/callback?" +
                                        ...
                                        "&email="
                                        + URLEncoder.encode(authResponse.getUser().getEmail(), StandardCharsets.UTF_8) +
                                        "&username="
                                        + URLEncoder.encode(
                                                        authResponse.getUser().getUsername() != null
                                        ...
                                        "&role="
                                        + URLEncoder.encode(
                                                        authResponse.getUser().getRole() != null
                                        ...
                                        "&avatar="
                                        + URLEncoder.encode(
                                                        authResponse.getUser().getAvatar() != null
                                                                        ? authResponse.getUser().getAvatar()
                                                                        : "",
                                                        StandardCharsets.UTF_8)
                                        +
                                        "&isPremium="
                                        + (authResponse.getUser().getIsPremium() != null
                                                        ? authResponse.getUser().getIsPremium()
                                                        : false)
                                        +
                                        "&balance="
                                        + (authResponse.getUser().getBalance() != null
                                                        ? authResponse.getUser().getBalance()
                                                        : "0");
